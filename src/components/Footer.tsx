      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <p className="text-zinc-500 text-xs">Software &amp; AI Engineer &middot; Bangalore, India</p>
          </div>
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-white hover:border-zinc-600 hover:-translate-y-px transition-all duration-200"
                >
                  <Icon size={16} />
                </a>
              );
          ...
          <p className="text-zinc-600 text-xs text-center">
            &copy; {year} Anmol Varshney &middot; Built with React &amp; Tailwind
          </p>
        </div>
      </div>
    </footer>
